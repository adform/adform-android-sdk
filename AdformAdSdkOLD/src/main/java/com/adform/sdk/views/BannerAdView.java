...
public class BannerAdView extends RelativeLayout {
	...
	public BannerAdView(final Context context, final AdServingEntity response, final AdListener adListener) {
	...
	public BannerAdView(final Context context, final AdServingEntity response, final boolean animation, final AdListener adListener) {
		super(context);
...
//	}
	...
	private void showContent() {
		...
		try {
            ...
            if (response != null) {
                webView.loadData(response.getAdEntity().getTagDataEntity().getSrc(), "text/html", Const.ENCODING);
            }
